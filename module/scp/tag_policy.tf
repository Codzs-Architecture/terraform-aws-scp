  ...
  content = jsonencode({
    "tags" = {
      ...
      "Environment" = {
        ...
        "tag_value"    = { "@@assign" = split(",", data.aws_ssm_parameter.environment_tag_value.value) },
        "enforced_for" = { "@@assign" = var.enforce_for_values }
      },
      "Owner" = {
        "tag_key"      = { "@@assign" = module.tags_client.owner_tag_key },
        "tag_value"    = { "@@assign" = tolist([var.application_name]) },
        "enforced_for" = { "@@assign" = var.enforce_for_values }
      },
      "CostCenter" = {
        "tag_key"      = { "@@assign" = module.tags_client.costcenter_tag_key },
        "tag_value"    = { "@@assign" = split(",", data.aws_ssm_parameter.costcenter_tag_value.value) },
        "enforced_for" = { "@@assign" = var.enforce_for_values }
      },
      "Application" = {
        "tag_key"      = { "@@assign" = module.tags_client.application_tag_key },
        "tag_value"    = { "@@assign" = split(",", data.aws_ssm_parameter.application_tag_value.value) },
        "enforced_for" = { "@@assign" = var.enforce_for_values }
      },
      "Platform" = {
        "tag_key"      = { "@@assign" = module.tags_client.platform_tag_key },
        "tag_value"    = { "@@assign" = split(",", data.aws_ssm_parameter.platform_tag_value.value) },
        "enforced_for" = { "@@assign" = var.enforce_for_values }
      },
      "Organization" = {
      ...
      "Department" = {
        ...
        "tag_value"    = { "@@assign" = split(",", data.aws_ssm_parameter.department_tag_value.value) },
        "enforced_for" = { "@@assign" = var.enforce_for_values }
      },
      "PowerManagement" = {
        "tag_key"      = { "@@assign" = module.tags_client.power_management_tag_key },
        "tag_value"    = { "@@assign" = split(",", data.aws_ssm_parameter.power_management_tag_value.value) },
        "enforced_for" = { "@@assign" = var.enforce_for_values }
      }
    }
  })
